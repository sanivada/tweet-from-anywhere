...
## Usage:
1. Download the latest .xpi file from [releases](https://github.com/sanivada/tweet-from-anywhere/releases)
2. Go to `about:addons` on firefox
3. Click *Install add-on from file* in settings (gear icon) menu
